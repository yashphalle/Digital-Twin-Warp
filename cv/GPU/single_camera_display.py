...
class SingleCameraDisplay:
    ...
    def __init__(self, camera_id: int = 11):
        ...
        self.use_fisheye_correction = False  # Start with fisheye correction OFF to test
    ...
    def _display_loop(self):
        ...
        # Use smaller initial size to ensure full image is visible
        initial_width = 1280  # Smaller initial size
        initial_height = 720  # 720p initial size
        cv2.resizeWindow(self.window_name, initial_width, initial_height)
        print(f"DEBUG: Window sized to {initial_width}x{initial_height} for 4K content")
    ...
    def _process_frame(self, frame: np.ndarray) -> np.ndarray:
        ...
        # NO RESIZING - Keep original camera quality (4K resolution) - SAME AS OPTMIZED FOLDER
...
def main():
    ...
    print("SINGLE CAMERA DISPLAY - CAMERA 8")
    print("=" * 50)
    print("This will show Camera 8 feed in a dedicated window")
    print("Controls:")
    print("  'q' or ESC - Quit")
    ...
    # Create display system for camera 8 (your test camera)
    camera_display = SingleCameraDisplay(camera_id=8)
