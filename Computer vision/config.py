...
class Config:
    ...
    GOOD_MATCH_RATIO = 0.7  # Slightly more strict ratio test
    MATCH_SCORE_THRESHOLD = 0.2  # Higher threshold for more confident matches

    # Tracking parameters
    MAX_DISAPPEARED_FRAMES = 30
    # SPATIAL_THRESHOLD = 150  # Removed - spatial filtering disabled for moving objects
